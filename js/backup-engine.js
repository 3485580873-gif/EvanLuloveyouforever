...
(function (global) {
    ...
    function buildModuleSkipPatterns(flags) {
        ...
        if (!flags.inclCustom) p.push('customReplies', 'customPokes', 'quickPokes', 'customStatuses', 'customMottos', 'customIntros', 'customEmojis', 'customReplyGroups', 'customPokeGroups', 'customStatusGroups');
