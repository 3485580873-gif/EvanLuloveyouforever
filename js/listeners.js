            ...
            DOMElements.pokeModal.save.addEventListener('click', () => {
                ...
                if (saveToQuick) {
                    ...
                    try {
                        ...
                        if (typeof showNotification === 'function') showNotification('已保存到快捷拍一拍 ✓', 'success', 1800);
                    } catch (e) {
                    ...
                    try {
                        ...
                        if (typeof showNotification === 'function') showNotification('已保存到字卡库拍一拍 ✓', 'success', 1800);
                    } catch (e) {
