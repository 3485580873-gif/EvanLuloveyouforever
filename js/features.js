...
function showPokeTab() {
    ...
    quickPokes.forEach((pokeText, index) => {
        ...
        editBtn.addEventListener('mouseover', () => {
            editBtn.style.background = 'rgba(var(--accent-color-rgb), 0.2)';
            editBtn.style.borderColor = 'var(--accent-color)';
            editBtn.style.color = 'var(--accent-color)';
        });
        editBtn.addEventListener('mouseout', () => {
            editBtn.style.background = 'rgba(var(--accent-color-rgb), 0.08)';
            editBtn.style.borderColor = 'rgba(var(--accent-color-rgb), 0.15)';
        ...
        delBtn.addEventListener('mouseover', () => {
            delBtn.style.background = 'rgba(255, 80, 80, 0.15)';
            delBtn.style.borderColor = 'rgba(255, 80, 80, 0.4)';
            delBtn.style.color = '#ff5050';
        });
        delBtn.addEventListener('mouseout', () => {
            delBtn.style.background = 'rgba(var(--accent-color-rgb), 0.08)';
            delBtn.style.borderColor = 'rgba(var(--accent-color-rgb), 0.15)';
